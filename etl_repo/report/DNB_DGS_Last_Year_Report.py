...
report_name='DNB_Deposito Garantie Stelsel_'+current_year
report_query='''SELECT Extract(year FROM as_of_date) AS "Year", 
...
print('Report Successfully Generated for Year : ',current_year)
